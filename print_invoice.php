...
foreach($invoiceItems as $invoiceItem){
	...
	<td align="left">'.$invoiceItem["order_item_subtotal"].'</td>
	<td align="left">'.$invoiceItem["order_item_tax"].'%</td>
	<td align="left">'.$invoiceItem["order_item_final_amount"].'</td>   
	</tr>';
}
$output .= '
	<tr>
	<td align="right" colspan="5"><b>Sub Total without Tax</b></td>
	<td align="left"><b>$'.$invoiceValues['order_total_before_tax'].'</b></td>
	</tr>
	<tr>
	<td align="right" colspan="5"><b>Discount Amount :</b></td>
	<td align="left">'.$invoiceValues['order_dis_per'].'%</td>
	</tr>
	<tr>
